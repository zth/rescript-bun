...
module Writable = {
  ...
  module Impl = {
    ...
    external writeWith: (
      subtype<[> writable<'w>]>,
      'w,
      ~callback: Nullable.t<JsExn.t> => unit=?,
      unit,
    ) => bool = "write"
    @get
  ...
  external makeOptionsObjMode: (
    ...
    ~writev: @this (
      objStream<'w>,
      ~data: array<chunk<'w>>,
      ~encoding: Null.t<StringEncoding.t>,
      ~callback: (~error: option<JsExn.t>) => unit,
    ) => unit=?,
    ~write: @this (
      objStream<'w>,
...
module Readable = {
  ...
  module Impl = {
    ...
    @get
    external readableEncoding: subtype<[> readable<'r>]> => Nullable.t<string> = "readableEncoding"
    @get
  ...
  external makeOptions: (
    ...
    ~read: @this (t<'r>, ~size: Nullable.t<int>) => unit,
    unit,
  ) => makeOptions<'r> = ""
  @module("node:stream") @new
  ...
  external makeOptionsObjMode: (
    ...
    ~read: @this (objStream<'r>, ~size: Nullable.t<int>) => unit,
    unit,
...
module Duplex = {
  ...
  external makeOptions: (
    ...
    ~read: @this (t<'w, 'r>, ~size: Nullable.t<int>) => unit,
    ~write: @this (
      t<'w, 'r>,
      ~data: 'w,
      ~encoding: StringEncoding.t,
  ...
  external makeOptionsObjMode: (
    ...
    ~read: @this (objStream<'w, 'r>, ~size: Nullable.t<int>) => unit,
    ~write: @this (
      objStream<'w, 'r>,
      ~data: 'w,
      ~encoding: StringEncoding.t,
...
@module("node:stream")
external finished: (subtype<'ty>, Nullable.t<JsExn.t> => unit) => cleanupFn = "finished"
